...
class ColorDark {
  ...
  Colors backgroung_main = HexColor('#1A1A1D') as Colors;
  Colors backgroung_add = HexColor('#C3073F') as Colors;
...
class ColorLight {
  ...
  Colors backgroung_main = HexColor('#D8C3A5') as Colors;
  Colors backgroung_add = HexColor('#EAE7DC') as Colors;
